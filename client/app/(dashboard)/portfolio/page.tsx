...
export default function Portfolio() {
  return (
    <div className="bg-gray-50 min-h-screen font-sans">
      ...
      {/* Footer */}
            {/* Footer */}
      <footer className="bg-white py-6 mt-12 text-center text-gray-500 text-sm border-t">
        <div className="flex flex-col md:flex-row justify-center items-center gap-4">
          <span>
            &copy; {new Date().getFullYear()} <span className="font-semibold text-indigo-700">Kamal Kumar</span> &amp; <span className="font-semibold text-pink-700">Ankit Singh</span>. All rights reserved.
          </span>
          <span className="flex gap-3 justify-center mt-2 md:mt-0">
            <a
              href="mailto:kamal.kumar@email.com"
            ...
            <a
              href="mailto:ankit.singh@email.com"
            ...
            <a
              href="https://github.com/kamalk151"
