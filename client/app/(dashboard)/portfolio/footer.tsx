      ...
      <section id="contact" className="container mx-auto py-12 px-6 text-center">
        ...
        >
          ...
          >
            ...
            {/* Services */}
      <section id="services" className="container mx-auto py-12 px-6 text-center">
        <h2 className="text-3xl font-bold text-indigo-700 mb-4">Our Services</h2>
        <p className="text-gray-700 mb-8">
          Want to create a web application for your business or idea? We offer professional MERN stack development for all needs. Choose a package or contact us for a custom quote!
        </p>
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          {/* Static Website Package */}
          <div className="bg-white rounded-lg shadow p-6 flex flex-col items-center border-t-4 border-indigo-500">
            <h3 className="text-xl font-semibold mb-2 text-indigo-700">Static Website</h3>
            <p className="text-gray-600 mb-4">Perfect for portfolios, small businesses, and landing pages.</p>
            <div className="text-3xl font-bold text-indigo-700 mb-2">₹7,000+</div>
            <ul className="text-gray-600 text-left mb-4 list-disc list-inside">
              <li>Up to 5 pages</li>
              <li>Responsive design</li>
              <li>Contact form</li>
              <li>Deployed & SEO ready</li>
            </ul>
            <span className="inline-block bg-indigo-100 text-indigo-700 px-4 py-1 rounded-full text-sm mb-2">Starting Price</span>
          </div>
          {/* Dynamic Web App Package */}
          <div className="bg-white rounded-lg shadow p-6 flex flex-col items-center border-t-4 border-pink-500">
            <h3 className="text-xl font-semibold mb-2 text-pink-700">Dynamic Web App</h3>
            <p className="text-gray-600 mb-4">For startups, e-commerce, dashboards, and custom solutions.</p>
            <div className="text-3xl font-bold text-pink-700 mb-2">₹15,000+</div>
            <ul className="text-gray-600 text-left mb-4 list-disc list-inside">
              <li>Admin panel</li>
            ...
            <span className="inline-block bg-pink-100 text-pink-700 px-4 py-1 rounded-full text-sm mb-2">Starting Price</span>
          </div>
          {/* Custom Solution Package */}
          <div className="bg-white rounded-lg shadow p-6 flex flex-col items-center border-t-4 border-green-500">
            <h3 className="text-xl font-semibold mb-2 text-green-700">Custom Solution</h3>
            <p className="text-gray-600 mb-4">Enterprise, SaaS, or any unique requirement? Let's discuss!</p>
            <div className="text-3xl font-bold text-green-700 mb-2">Contact Us</div>
            <ul className="text-gray-600 text-left mb-4 list-disc list-inside">
            ...
            <span className="inline-block bg-green-100 text-green-700 px-4 py-1 rounded-full text-sm mb-2">Best Value</span>
          </div>
        </div>
        <a
          href="#contact"
