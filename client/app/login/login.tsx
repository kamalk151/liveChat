  ...
  return (
   <div className="feedback-container max-w-2xl mx-auto px-4 py-10">
    <div className="bg-white shadow-lg rounded-xl p-8">
      <h1 className="text-3xl font-bold text-gray-800 mb-4 text-center">Existing User</h1>
      <p className="text-gray-600 text-center mb-6">
        New user? <Link href="/signup" className="text-blue-600 hover:underline">Register here</Link>
      </p>
